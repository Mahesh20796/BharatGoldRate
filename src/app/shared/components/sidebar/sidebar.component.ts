  ...
  template: `
    <aside class="app-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-section-title">COMMUNITY & SOURCE</div>

        <a href="https://github.com/Mahesh20796/BharatGoldRate" target="_blank" rel="noopener noreferrer" class="nav-link external-link">
          <svg class="link-icon" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <span class="material-symbols-outlined external-icon" style="font-size: 14px; margin-left: auto; opacity: 0.6;">open_in_new</span>
        </a>
      </nav>
